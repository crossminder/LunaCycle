...
namespace WPControls
{
    ...
    public interface IDateToBrushConverter
    {
        ...
        /// <param name="dayType">type of day: StartCycleDay,CycleDay, EndCycleDay, StartFertilityDay, FertilityDay, EndFertilityDay, RegularDay.
        /// </param>
        ...
        Brush Convert(DateTime dateTime, bool isSelected, PeriodDayTypeEnum dayType, Brush defaultValue, BrushType brushType);
    }
}
