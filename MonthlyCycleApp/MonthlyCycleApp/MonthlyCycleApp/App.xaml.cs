...
namespace MonthlyCycleApp
{
    public partial class App : Application
    {
        ...
        private static SetupViewModel setupViewModel = null;
        ...
        private static LunaDropControlViewModel lunaViewModel = null;

        public static LunaDropControlViewModel LunaViewModel
        {
            get
            {
                // Delay creation of the view model until necessary
                if (lunaViewModel == null)
                    lunaViewModel = new LunaDropControlViewModel();
